	...
	var tmp, loading, overlay, wrap, outer, content, close, title, nav_left, nav_right,
		...
		_finish = function () {
			...
			if (currentOpts.type == 'iframe') {
				...
				$('<iframe id="fancybox_fp-frame" name="fancybox_fp-frame' + new Date().getTime() + '" frameborder="0" hspace="0" ' + ($.browser.msie ? 'allowtransparency="true""' : '') + ' scrolling="' + selectedOpts.scrolling + '" src="' + currentOpts.href + '" AllowFullScreen ></iframe>').appendTo(content).on("load",function(){
